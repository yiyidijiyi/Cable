...
QT_MOC_LITERAL(1, 7, 18), // "Signal_ImageSnaped"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "Camera\0Signal_ImageSnaped\0"
};
...
void Camera::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Signal_ImageSnaped(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Camera::Signal_ImageSnaped)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Camera::Signal_ImageSnaped()
{
